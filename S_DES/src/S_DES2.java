...
public class S_DES2 {
 ...
 /*       System.out.println("请输入主密匙(10bit):");
  ...
  /*      System.out.println("请输入加密信息:");
        ...
        Plainttext=AsciiToBinary(Plainttext);
        ...
        //BinaryToAscii(ciphertext);
        return BinaryToAscii(ciphertext);
    }
    /*解密*/
...
/*        System.out.println("请输入解密信息(8bit):");
        ...
        BinaryToAscii(Plainttext);
        return BinaryToAscii(Plainttext);
    }
    /*置换*/
